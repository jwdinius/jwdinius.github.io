...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\indent I am an experienced robotics engineer seeking opportunities for both personal and professional growth.  I am a fast learner, a motivating force, and have led technical efforts in sensing and estimation, path planning, localization, and computer vision.  On the technical side, I enjoy solving new problems creatively and timely.  On the leadership side, I focus on regular interpersonal communication, making expectations plainly known, and on identifying and providing any support necessary for optimizing team output.  In everything I do, I strive to communicate clearly, candidly, and respectfully.
...
\item
    \headerrow{\textbf{UBTECH Robotics North American R\&D Center}}{Los Angeles, CA}
        \headerrow{\emph{Senior Research Engineer -- Navigation \& Control}}{April 2019 -- Present}
	{\small
	\begin{itemize}[noitemsep]
		\resitem{Responsibilities include: software team recruiting, system requirements development, and navigation team oversight}
		\resitem{Developing SLAM algorithms for operation in dynamic environments}
        \resitem{Oversee ongoing software development efforts for initial prototype}
	\end{itemize}
	}
\item
	...
	\begin{itemize}[noitemsep]
        ...
        \resitem{Other responsibilities included: cycle-time reduction, build management (CI and configuration control), system identification and test, and obstacle avoidance.}
	\end{itemize}
	}
\item
...
\begin{tabular}{ll}
   OS &: Windows, OS X, Ubuntu\\
    ...
    & \ gdb(pdb), cmake, valgrind, numpy, scipy, pandas, \LaTeX , Boost, IPOPT, ROS, fastai, PyTorch, docker \\
