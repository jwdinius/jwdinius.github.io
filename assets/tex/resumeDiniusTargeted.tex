...
\item
	...
	\begin{itemize}[noitemsep]
        \resitem{Transitioned to functional leadership role shortly after joining: (\textit{14 direct reports})}
        \begin{itemize}[noitemsep]
                ...
                \resitem{Technical lead (upwards of 7 team members) on single vehicle autonomy R \& D team.  Responsibilities include program management, application infrastructure development for fixed-wing and multirotor craft, and visual navigation algorithm development and testing}
                \resitem{Initiator and champion of several internal process improvement efforts: \textit{Legacy CM/CI to Gitlab, containers for application development and deployment, and embracing open-source projects}}
        \end{itemize}
	\end{itemize}
	}
	...
	{\small
	\begin{itemize}[noitemsep]
        \resitem{Developed robust visual navigation capability for autonomous aerial vehicles with multiple monochrome imagers (with different quantum efficiencies) for indoor and outdoor environments}
	\end{itemize}
	}
\item
