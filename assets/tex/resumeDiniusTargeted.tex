...
\item
	...
	\begin{itemize}[noitemsep]
        \resitem{Transitioned to leadership role shortly after joining: (\textit{$\sim$15 direct reports})}
        \begin{itemize}[noitemsep]
                \resitem{\textbf{Responsibility split: 80\% technical, 20\% personnel management}}
...
\item
        \headerrow{\textbf{Traffic Sign Recognition}}{July 2019}
        {\small
	\begin{itemize}[noitemsep]
...
\begin{tabular}{ll}
   OS &: Windows, OS X, Ubuntu\\
    ...
    & \ Intel NUC, Xilinx Zynq UltraScale+ MpSoC \\
    Software \ &: Eigen, Armadillo, Scikit-image, Scikit-learn, OpenCV, Fast-DDS, Matlab/Simulink, git, \\
