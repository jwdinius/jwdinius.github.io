...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\indent I am an experienced robotics engineer seeking technical leadership opportunities in autonomous systems development.  I am a fast learner, a motivating force, and have led technical efforts in sensing and estimation, path planning, localization, and computer vision.  On the technical side, I enjoy solving hard problems with creativity; employing solutions that others might not consider.  On the leadership side, I focus on regular interpersonal communication, making expectations plainly known, and on identifying and providing any support necessary for optimizing team output.  In everything I do, I strive to communicate clearly, candidly, and respectfully.
...
\item
    ...
    \headerrow{\emph{Senior Staff Engineer -- Autonomy \& Robotics}}{December 2019 -- Present}
	{\small
	\begin{itemize}[noitemsep]
		\resitem{Developing visual inertial odometry capability for autonomous aerial vehicles in multiple operational environments}
        \resitem{Defining and helping to implement processes and methodologies for scaling autonomous capabilities within the company's product lines}
	\end{itemize}
	}
\item
	...
	\begin{itemize}[noitemsep]
        ...
        \begin{itemize}[noitemsep]
                ...
                \resitem{Grew the team from 1 to 15+ in 8 months.  Total team, including hardware and industrial design, grew to 35+}
        \end{itemize}
        ...
        \begin{itemize}[noitemsep]
                ...
                \resitem{Worked closely with hardware design team to do sensor coverage analyses and hardware downselect in early stages}
                \resitem{Led team of 3-5 individuals working on autonomously navigating mobile platform.  Milestone demo achieved in $\sim$4.5 months: Starting from concept-only (no drawings) to fully-functional MVP}
		        ...
		        \resitem{Encouraged short feedback cycles between team and project leadership via daily standups, concise documentation of work, and frequent mini-demonstrations}
        \end{itemize}
	\end{itemize}
	}
\item
	...
	\begin{itemize}[noitemsep]
        ...
        \begin{itemize}[noitemsep]
                ...
                \resitem{Increased navigation accuracy on precision maneuvers by over 5x while simultaneously increasing speed by 2x; \textit{reduced inventory drops due to navigation failures} 10x}
        \end{itemize}
...
\item
	...
	\begin{itemize}[noitemsep]
	 \resitem{Led teams in simulation, control, and signal/image processing disciplines}
        \begin{itemize}[noitemsep]
                \resitem{Worked with team members to define performance targets for yearly reviews; contributed to performance reports and conducted reviews}
...
\begin{itemize}[label={},leftmargin=*,noitemsep]
\item
        \headerrow{\textbf{Traffic Sign Recognition using fastai}}{July 2019}
        {\small
	\begin{itemize}[noitemsep]
	    \resitem{Built an end-to-end pipeline for performing classification on the German Traffic Sign Recognition Benchmark dataset}
            \resitem{Used modern techniques -- including use of a residual network (ResNet34) as the back-bone architecture and learning rate annealing}
		\resitem{Achieved SOTA accuracy on a holdout set -- 99.95\% vs. competition winning 99.46\% of a few years ago}
		\resitem{\href{https://jwdinius.github.io/projects/german-traffic-signs-project/}{Project Writeup}, \href{https://github.com/jwdinius/traffic-sign-recognition-fastai}{Github}.  Technologies Used: Python, PyTorch, fastai, docker}
	\end{itemize}
	}
\item
	...
	{\small
	\begin{itemize}[noitemsep]
            \resitem{Created and integrated a simple SLAM-inspired algorithm to increase precision navigation terminal accuracy 5x.  The net effect was a 3-4x decrease in inventory drops.}
...
\begin{tabular}{ll}
   OS &: Windows, OS X, Ubuntu\\
    Languages &: Modern C++ (11/14/17 standards), Python, Fortran (77 \& 90/95) \\
    Software \ &: Eigen, Armadillo, Scikit-image, Scikit-learn, Tensorflow, Keras, OpenCV, Matlab/Simulink, git, \\
    ...
    & \ design-of-experiments (DoE), data exploration \& visualization
\end{tabular} \\
