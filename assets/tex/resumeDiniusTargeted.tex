...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\indent I am an experienced systems engineer seeking new professional growth opportunities in robotics and autonomous systems.  I am a fast learner, a motivating force, and have led technical efforts in sensing and estimation, path planning, localization, and computer vision in the robotics-domain.  On the technical side, I enjoy solving novel problems creatively and, most importantly, timely.  On the leadership side, I focus on regular interpersonal communication, making expectations plainly known, and on identifying and providing any support necessary for optimal team output.  In everything I do, I strive to communicate clearly, candidly, and respectfully.
...
\item
	...
	\begin{itemize}[noitemsep]
		\resitem{Responsible for development of control, navigation, and localization algorithms for wheeled mobile robots for a warehouse automation application}
		\resitem{Increased coarse navigation speed 2.5x in 2 months through a novel method}
        \resitem{Increased navigation accuracy on precision maneuvers by over 2x while simultaneously increasing speed by 2x}
            \resitem{Organize ongoing efforts for personal and professional growth of development team members}  
        \resitem{Other responsibilities include cycle-time reduction, build management (CI and configuration control), system test, and obstacle avoidance.}
	\end{itemize}
	}
\item
...
\item
	...
	{\small
	\begin{itemize}[noitemsep]
	 \resitem{Led teams in simulation, control, and signal/image processing disciplines}
	 \resitem{Directed analyses of flight test failure, operational safety, requirements development, and system performance}
     \resitem{Designed and developed simulation architectures for new product development efforts (DARPA/MDA/etc)}
...
\item
	...
	\begin{itemize}[noitemsep]
		...
		\resitem{Performed feature extraction using OpenCV to increase classifier accuracy}
		\resitem{Developed a blob detector to find minimal bounding boxes around detected objects}
		\resitem{Implemented a Kalman filter to smoothly track bounding boxes}
...
\begin{tabular}{ll}
   OS &: Windows, OS X, Ubuntu\\
    ...
    & \ cmake, valgrind, numpy, scipy, pandas, \LaTeX , Boost, IPOPT \\
   Other &: Kalman filtering, particle filtering, localization, computer vision, machine learning, \\
   & \ state-space control design, optimal control, design-of-experiments (DoE), \\
