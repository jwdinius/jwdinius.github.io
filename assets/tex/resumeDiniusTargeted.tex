...
\item
	\headerrow{\textbf{AeroVironment, Inc.}}{Moorpark, CA}
    \headerrow{\emph{Principal Software Engineer (Apps)}}{March 2023 -- Present}
	{\small
	\begin{itemize}[noitemsep]
        \resitem{Chief Engineer for \href{https://www.avinc.com/resources/press-releases/view/av-unveils-new-ai-capability-and-autonomy-kit-for-unmanned-systems}{AV's autonomy software framework product}}
        \begin{itemize}[noitemsep]
                \resitem{Transitioned R \& D software focused on demonstration to a fieldable and maintainable product:}
                \begin{itemize}[noitemsep]
                    \resitem{\textbf{Led technical team of 8-12 individuals}}
                    \resitem{\textbf{Performed ground-up redesign to ensure software architecture is performant, extensible, and scalable}}
                    \resitem{\textbf{Refactored and rewrote existing software modules to ensure adherence to the new software architecture}}
                    \resitem{\textbf{Decreased software deployment time (~5x) following methods of Infrastructure-as-Code (IaC)}}
                    \resitem{\textbf{Developed comprehensive quality assurance (QA) plan linking systems requirements (in JAMA) to feature descriptions (in Jira) to test cases and execution results (in Jira/Xray)}}
                    \resitem{\textbf{Achieved unprecendented release rate (4x per year, compared to 1 release per 1.5-2 years on other software programs within the company) through a high degree of test and release automation}}
                \end{itemize}
                \resitem{Demonstrated viability of software product through successful integrations on four (4) reference hardware platforms:}
                \begin{itemize}[noitemsep]
                    \resitem{\textbf{Integration achieved with minimal intervention from the core software framework team}}
                    \resitem{\textbf{Fast rate of integration due to a high degree of code reuse across integrations}}
                \end{itemize}
        \end{itemize}
	\end{itemize}
	}
