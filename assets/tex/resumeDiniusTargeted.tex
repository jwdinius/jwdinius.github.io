...
\begin{tabular}{ll}
   ...
   Frameworks/Libraries \ &: Eigen, Scikit-image, Scikit-learn, Tensorflow, Keras, OpenCV\\
   Other &: Kalman filtering, particle filtering, localization, computer vision, \\
    \phantom{other} &\phantom{:} machine learning, data exploration \& visualization
\end{tabular} \\
