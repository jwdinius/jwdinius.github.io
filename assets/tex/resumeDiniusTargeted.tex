...
\item
    \headerrow{\textbf{UBTECH Robotics North American R\&D Center}}{Los Angeles, CA}
        \headerrow{\emph{Senior Research Engineer -- Perception \& Computer Vision}}{April 2019 -- Present}
	{\small
	\begin{itemize}[noitemsep]
		\resitem{Responsible for software team hiring}
		\resitem{Developing cutting-edge visual SLAM algorithm for application in dynamic environments}
        \resitem{Support product prototype development through software}
        \resitem{Other responsibilities including: team-building and new business development}
	\end{itemize}
	}
\item
	...
	\begin{itemize}[noitemsep]
        ...
        \resitem{Organized ongoing efforts for personal and professional growth of team members}  
        \resitem{Other responsibilities included: cycle-time reduction, build management (CI and configuration control), system test, and obstacle avoidance.}
	\end{itemize}
	}
\item
...
\item
	...
	\begin{itemize}[noitemsep]
		...
		\resitem{\href{https://github.com/jwdinius/extended-object-tracking}{Github}.  Technologies Used: C++, JUCE}
	\end{itemize}
	}
\item
	...
	\begin{itemize}[noitemsep]
		...
		\resitem{\href{https://jwdinius.github.io/projects/vehicle_detections/}{Project Writeup}.  Technologies Used: Python, OpenCV, Scikit-learn}
	\end{itemize}
	}
    %\newpage
\end{itemize}
...
\begin{tabular}{ll}
   OS &: Windows, OS X, Ubuntu\\
    Languages &: C++ (post 11), Python (2 \& 3), Fortran (77 \& 90/95) \\
    Software \ &: Eigen, Scikit-image, Scikit-learn, Tensorflow, Keras, OpenCV, Matlab/Simulink, git, gdb(pdb), \\
    & \ cmake, valgrind, numpy, scipy, pandas, \LaTeX , Boost, IPOPT, ROS, fastai, PyTorch, docker \\
    Other &: Kalman filtering, particle filtering, localization / SLAM, computer vision, \\
